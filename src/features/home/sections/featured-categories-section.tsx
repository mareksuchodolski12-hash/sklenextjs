      ...
      <div className="space-y-8">
        ...
        <div className="grid gap-5 md:grid-cols-3">
          {categories.map((category) => (
            <article
              key={category.title}
              className="rounded-2xl border border-brand-sage/20 bg-white p-6 shadow-soft"
            >
              ...
              <Link
                href={category.href}
                className="mt-5 inline-flex text-sm font-semibold text-brand-moss underline-offset-4 hover:underline"
              >
                Explore category
              </Link>
            </article>
