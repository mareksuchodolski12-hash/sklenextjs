...
export const metadata: Metadata = {
  ...
  description:
    'Complete your premium garden flower order details and continue to secure Stripe payment.',
};
      ...
      <Container className="space-y-6">
        <div className="space-y-3">
          ...
          <p className="max-w-3xl text-sm leading-relaxed text-brand-charcoal/75 sm:text-base">
            ...
            Payments are securely handled by Stripe, while post-payment order orchestration remains
            intentionally scoped for the next phase.
          </p>
          <Link
            href="/plants"
